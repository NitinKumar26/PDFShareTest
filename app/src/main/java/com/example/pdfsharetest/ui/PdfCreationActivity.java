package com.example.pdfsharetest.ui;
...
import com.example.pdfsharetest.R;
import com.example.pdfsharetest.adapter.PdfCreateAdapter;
import com.example.pdfsharetest.model.PDFModel;
import com.example.pdfsharetest.utils.PDFCreationUtils;
import com.example.pdfsharetest.utils.PdfBitmapCache;

import java.io.File;
import java.util.ArrayList;
import java.util.List;
import com.example.pdfsharetest.BuildConfig;
...
public class PdfCreationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("size", String.valueOf(pdfModels.size()));

        Log.e("title", pdfModels.get(0).getName());
        ...
        Log.e("pdfAdapter", String.valueOf(pdfRootAdapter.getItemCount()));
