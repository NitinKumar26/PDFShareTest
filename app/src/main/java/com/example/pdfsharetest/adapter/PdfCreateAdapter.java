package com.example.pdfsharetest.adapter;
...
public class PdfCreateAdapter extends RecyclerView.Adapter<PdfCreateAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pdf_creation, parent, false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mReceivedTV = (TextView) itemView.findViewById(R.id.tv_received);
            mNameTV = (TextView) itemView.findViewById(R.id.tv_name);
            mRateIM = (ImageView) itemView.findViewById(R.id.iv_rate);
        }
    }
}
